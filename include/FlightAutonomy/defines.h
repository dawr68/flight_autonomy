...
const float MAX_YAWSPEED = 30;       /**< Maksymalna wartość prędkości kątowej w osi yaw w stopniach na sekunde */
...
const int FORWARD_FLIGHT_TIMEOUT = 2; /**< Czas przez który maszyna leci do przodu aby pokonać przeszkodę */